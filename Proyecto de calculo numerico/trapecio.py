...
def trapecio_integration():
    ...
    integral_aproximada = suma * delta_x
    ...
    print(f"Ancho de subintervalo (Δx): {delta_x:.4f}")
    # Cálculo del error
    error = abs((integral_real - integral_aproximada) / integral_real)
    print(f"Error : {error:.4f}")

# Ejecutar el método
if __name__ == "__main__":
    trapecio_integration()